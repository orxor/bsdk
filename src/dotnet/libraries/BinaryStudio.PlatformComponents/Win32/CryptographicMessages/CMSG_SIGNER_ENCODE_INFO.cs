...
namespace BinaryStudio.PlatformComponents.Win32
    {
    public interface CMSG_SIGNER_ENCODE_INFO
        {
        }

    [StructLayout(LayoutKind.Sequential)]
    public struct CMSG_SIGNER_ENCODE_INFO32 : CMSG_SIGNER_ENCODE_INFO
        {
        public Int32 Size;
    ...
    [StructLayout(LayoutKind.Sequential)]
    public struct CMSG_SIGNER_ENCODE_INFO64 : CMSG_SIGNER_ENCODE_INFO
        {
        public Int32 Size;
        public unsafe CERT_INFO* CertInfo;
        public IntPtr CryptProvOrKey;
