...
namespace BinaryStudio.PortableExecutable.CodeView
    ...
    internal class S_REGISTER16 : CodeViewSymbol
        ...
        public UInt16 TypeIndex { get; }
        public UInt16 RegisterIndex { get; }
        ...
        public override void WriteTo(TextWriter Writer, String LinePrefix, FileDumpFlags Flags) {
            Writer.WriteLine("{0}Offset:{1:x8} Type:{2} TypeIndex:{3:x4} Register:{4}", LinePrefix,Offset,Type,TypeIndex,DecodeRegister(RegisterIndex));
