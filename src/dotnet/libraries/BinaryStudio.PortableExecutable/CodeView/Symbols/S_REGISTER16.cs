...
namespace BinaryStudio.PortableExecutable.CodeView
    ...
    internal class S_REGISTER16_TD32 : CodeViewSymbol
        {
        public override DEBUG_SYMBOL_INDEX Type { get { return DEBUG_SYMBOL_INDEX.S_REGISTER16; }}
        public Int16 TypeIndex { get; }
        ...
        public unsafe S_REGISTER16_TD32(CodeViewSymbolsSSection Section, Int32 Offset, IntPtr Content, Int32 Length)
            : base(Section, Offset, Content, Length)
            {
            var Header = (CODEVIEW_REGSYM16_TD32*)Content;
            TypeIndex = Header->TypeIndex;
            Register = Header->Register;
        ...
        public override void WriteTo(TextWriter Writer, String LinePrefix, FileDumpFlags Flags) {
            Writer.WriteLine("{0}Offset:{1:x8} Type:{2} TypeIndex:{3:x4} Register:{4:x4}", LinePrefix,Offset,Type,TypeIndex,Register);
