...
namespace BinaryStudio.PortableExecutable.CodeView
    {
    [CodeViewLeafIndex(LEAF_ENUM.LF_CLASS_16)]
    internal class LF_CLASS_16 : CodeViewTypeInfo
        {
        ...
        private struct HEADER
            ...
            public readonly UInt16 DerivedTypeIndex;
            public readonly UInt16 VShapeTableTypeIndex;
        ...
        private readonly UInt16 DerivedTypeIndex;
        private readonly UInt16 VShapeTableTypeIndex;
        ...
        public unsafe LF_CLASS_16(IntPtr Content, Int32 Size)
            : base(Content, Size)
            {
            var r = (HEADER*)Content;
            ElementsCount = r->ElementsCount;
            FieldTypeIndex = r->FieldTypeIndex;
            DerivedTypeIndex = r->DerivedTypeIndex;
            VShapeTableTypeIndex = r->VShapeTableTypeIndex;
        ...
        public override void WriteTo(IJsonWriter writer) {
            ...
            using (writer.Object()) {
                ...
                writer.WriteValue(nameof(DerivedTypeIndex),DerivedTypeIndex.ToString("x4"));
                writer.WriteValue(nameof(VShapeTableTypeIndex),VShapeTableTypeIndex.ToString("x4"));
                ...
                writer.WriteValue(nameof(Size),Size);
        ...
        public override void WriteTo(TextWriter Writer, String LinePrefix, FileDumpFlags DumpFlags) {
            ...
            Writer.WriteLine("{0}FieldTypeIndex:{1:x4} DerivedTypeIndex:{2:x4} VShapeTableTypeIndex:{3:x4}",LinePrefix,FieldTypeIndex,DerivedTypeIndex,VShapeTableTypeIndex);
            ...
            Writer.WriteLine("{0}Size:{1:x4} Name:{2}",LinePrefix,Size,Name);
            }
        }

    [CodeViewLeafIndex(LEAF_ENUM.LF_STRUCTURE_16)]
    [UsedImplicitly]
    internal class LF_STRUCTURE_16 : LF_CLASS_16
        {
        public LF_STRUCTURE_16(IntPtr Content, Int32 Size)
            : base(Content, Size)
            {
            }
        }
