...
namespace BinaryStudio.Security.Cryptography.CryptographyServiceProvider
    ...
    internal class CryptographicContextC : CryptographicContext, CryptographicFunctions
        ...
        [DllImport("libcapi20", SetLastError = true)] private static extern IntPtr CryptMsgOpenToDecode(CRYPT_MSG_TYPE EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,IntPtr CryptProv,IntPtr RecipientInfo,IntPtr si);
        [DllImport("libcapi20", SetLastError = true)] private static extern IntPtr CryptMsgOpenToDecode(CRYPT_MSG_TYPE EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,IntPtr CryptProv,IntPtr RecipientInfo,ref CMSG_STREAM_INFO si);
        [DllImport("libcapi20", SetLastError = true)] private static extern IntPtr CryptMsgOpenToEncode(CRYPT_MSG_TYPE EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,ref CMSG_SIGNED_ENCODE_INFO32 EncodeInfo,IntPtr InnerContentObjId,ref CMSG_STREAM_INFO StreamInfo);
        [DllImport("libcapi20", SetLastError = true)] private static extern IntPtr CryptMsgOpenToEncode(CRYPT_MSG_TYPE EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,ref CMSG_SIGNED_ENCODE_INFO64 EncodeInfo,IntPtr InnerContentObjId,ref CMSG_STREAM_INFO StreamInfo);
        [DllImport("libcapi20", SetLastError = true)] private static extern IntPtr CryptMsgOpenToEncode(CRYPT_MSG_TYPE EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,ref CMSG_ENVELOPED_ENCODE_INFO EncodeInfo,IntPtr InnerContentObjId,ref CMSG_STREAM_INFO StreamInfo);
