...
namespace BinaryStudio.Security.Cryptography.CryptographyServiceProvider
    ...
    internal class CryptographicContextS : CryptographicContext, CryptographicFunctions
        ...
        [DllImport("advapi32.dll", SetLastError = true)] private new static extern Boolean CryptGetKeyParam(IntPtr Key,KEY_PARAM Param,IntPtr Data,ref Int32 DataLen,Int32 Flags);
        ...
        [DllImport("advapi32.dll", SetLastError = true)] private static extern Boolean CryptDeriveKey(IntPtr Context,ALG_ID AlgId,IntPtr BaseData,Int32 Flags,out IntPtr Key);
        ...
        [DllImport("advapi32.dll", SetLastError = true)] private static extern Boolean CryptDuplicateHash(IntPtr Hash,IntPtr Reserved,Int32 Flags,out IntPtr Output);
        [DllImport("advapi32.dll", SetLastError = true)] private static extern Boolean CryptDuplicateKey(IntPtr Key,IntPtr Reserved,Int32 Flags,out IntPtr Output);
        ...
        [DllImport("advapi32.dll", SetLastError = true)] private static extern Boolean CryptSetHashParam(IntPtr Hash,Int32 Param,[MarshalAs(UnmanagedType.LPArray)] Byte[] Data,Int32 Flags);
        [DllImport("advapi32.dll", SetLastError = true)] private static extern Boolean CryptSetHashParam(IntPtr Hash,Int32 Param,ref CRYPT_DATA_BLOB Data,Int32 Flags);
        [DllImport("advapi32.dll", SetLastError = true)] private static extern Boolean CryptSetHashParam(IntPtr Hash,Int32 Param,IntPtr Data,Int32 Flags);
        ...
        [DllImport("crypt32.dll", SetLastError = true)] private static extern Boolean CertCloseStore(IntPtr handle, Int32 flags);
        ...
        [DllImport("crypt32.dll", SetLastError = true)] private static extern IntPtr CryptMsgOpenToDecode(Int32 MsgEncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,IntPtr CryptProv,IntPtr RecipientInfo,IntPtr StreamInfo);
        [DllImport("crypt32.dll", SetLastError = true)] private static extern IntPtr CryptMsgOpenToDecode(Int32 MsgEncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,IntPtr CryptProv,IntPtr RecipientInfo,ref CMSG_STREAM_INFO StreamInfo);
        [DllImport("crypt32.dll", SetLastError = true)] private static extern IntPtr CryptMsgOpenToEncode(Int32 EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,ref CMSG_SIGNED_ENCODE_INFO32 EncodeInfo,IntPtr InnerContentObjId,ref CMSG_STREAM_INFO StreamInfo);
        [DllImport("crypt32.dll", SetLastError = true)] private static extern IntPtr CryptMsgOpenToEncode(Int32 EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,ref CMSG_SIGNED_ENCODE_INFO64 EncodeInfo,IntPtr InnerContentObjId,ref CMSG_STREAM_INFO StreamInfo);
        [DllImport("crypt32.dll", SetLastError = true)] private static extern IntPtr CryptMsgOpenToEncode(Int32 EncodingType,CRYPT_OPEN_MESSAGE_FLAGS Flags,CMSG_TYPE Type,ref CMSG_ENVELOPED_ENCODE_INFO EncodeInfo,IntPtr InnerContentObjId,ref CMSG_STREAM_INFO StreamInfo);
        ...
        [DllImport("crypt32.dll", SetLastError = true, EntryPoint = "PFXExportCertStore")] private static extern Boolean CertExportCertStore(IntPtr Store,ref CRYPT_DATA_BLOB PFX,IntPtr Password,Int32 Flags);
        ...
        unsafe Boolean CryptographicFunctions.CryptSetHashParam(IntPtr Hash,Int32 Param,Byte[] Data,Int32 Flags) {
            if ((Flags & CRYPT_PASS_THROUGHT_DATA_BLOB) == CRYPT_PASS_THROUGHT_DATA_BLOB) {
                fixed (Byte* o = Data) {
                    var r = new CRYPT_DATA_BLOB {
                        Data = o,
                        Size = Data.Length
                        };
                    return CryptSetHashParam(Hash,Param,(IntPtr)(&r), Flags & ~CRYPT_PASS_THROUGHT_DATA_BLOB);
                    }
                }
            return CryptSetHashParam(Hash,Param,Data,Flags);
            }
