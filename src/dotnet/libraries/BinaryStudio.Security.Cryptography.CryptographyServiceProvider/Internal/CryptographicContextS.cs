...
namespace BinaryStudio.Security.Cryptography.CryptographyServiceProvider
    ...
    internal class CryptographicContextS : CryptographicContext, CryptographicFunctions
        ...
        IntPtr CryptographicFunctions.CertCreateCRLContext(Int32 CertEncodingType,[MarshalAs(UnmanagedType.LPArray)] Byte[] CrlEncodedBytes,Int32 CrlEncodedLength) { return CertCreateCRLContext(CertEncodingType,CrlEncodedBytes,CrlEncodedLength); }
        ...
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true,EntryPoint="CertOpenStore")] private static extern IntPtr CertOpenStoreA(IntPtr StoreProvider, Int32 MsgAndCertEncodingType, IntPtr CryptProv, Int32 Flags, IntPtr Para);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true,EntryPoint="CertOpenStore")] private static extern IntPtr CertOpenStoreA(IntPtr StoreProvider, Int32 MsgAndCertEncodingType, IntPtr CryptProv, Int32 Flags, [MarshalAs(UnmanagedType.LPStr)] String Para);
        ...
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CryptMsgOpenToDecode(CRYPT_MSG_TYPE MsgEncodingType, CRYPT_OPEN_MESSAGE_FLAGS Flags, CMSG_TYPE Type, IntPtr CryptProv, IntPtr RecipientInfo, ref CMSG_STREAM_INFO si);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CryptMsgOpenToDecode(CRYPT_MSG_TYPE MsgEncodingType, CRYPT_OPEN_MESSAGE_FLAGS Flags, CMSG_TYPE Type, IntPtr CryptProv, IntPtr RecipientInfo, IntPtr si);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptMsgClose(IntPtr Message);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptMsgControl(IntPtr Message, CRYPT_MESSAGE_FLAGS Flags, CMSG_CTRL CtrlType, IntPtr CtrlPara);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptMsgControl(IntPtr Message, CRYPT_MESSAGE_FLAGS Flags, CMSG_CTRL CtrlType, ref CMSG_CTRL_DECRYPT_PARA CtrlPara);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptMsgUpdate(IntPtr Message, [MarshalAs(UnmanagedType.LPArray)] Byte[] Data, Int32 Size, Boolean Final);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptMsgUpdate(IntPtr Message, IntPtr Data, Int32 Size, Boolean Final);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptMsgGetParam(IntPtr Message, CMSG_PARAM Parameter, Int32 SignerIndex, [MarshalAs(UnmanagedType.LPArray)] Byte[] Data, ref Int32 Size);
        ...
        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)] private static extern Boolean CryptEnumProviders(Int32 index, IntPtr reserved, Int32 flags, out Int32 type, [In][Out] StringBuilder name, ref Int32 sz);
        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)] private static extern Boolean CryptEnumProviderTypes(Int32 index, IntPtr reserved, Int32 flags, out Int32 type, [In][Out] StringBuilder name, ref Int32 sz);
        [DllImport("advapi32.dll", CharSet = CharSet.Ansi, EntryPoint = "CryptAcquireContextA", SetLastError = true)] private static extern Boolean CryptAcquireContext(out IntPtr CryptProv, [MarshalAs(UnmanagedType.LPStr)] String Container, [MarshalAs(UnmanagedType.LPStr)]String Provider, Int32 ProvType, Int32 Flags);
        ...
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptAcquireCertificatePrivateKey(IntPtr Certificate, CRYPT_ACQUIRE_FLAGS Flags, IntPtr Parameters,out IntPtr CryptProvOrNCryptKey, out KEY_SPEC_TYPE KeySpec, out Boolean CallerFreeProvOrNCryptKey);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertGetCertificateContextProperty(IntPtr Context, CERT_PROP_ID PropertyIndex, [MarshalAs(UnmanagedType.LPArray)]Byte[] Data, ref Int32 Size);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertSetCertificateContextProperty(IntPtr Context, CERT_PROP_ID PropertyIndex, Int32 Flags, ref CRYPT_KEY_PROV_INFO Data);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertSetCertificateContextProperty(IntPtr Context, CERT_PROP_ID PropertyIndex, Int32 Flags, IntPtr Data);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptDeriveKey(IntPtr Context,ALG_ID AlgId,Int32 Flags,out IntPtr r);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptDestroyKey(IntPtr Key);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptDuplicateKey(IntPtr Key,IntPtr Reserved,Int32 Flags,out IntPtr r);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptExportKey(IntPtr Key,IntPtr ExpKey,Int32 BlobType,Int32 Flags, [MarshalAs(UnmanagedType.LPArray)] Byte[] Data,ref Int32 DataLen);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptGenKey(IntPtr Context,ALG_ID AlgId,Int32 Flags,out IntPtr r);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptGenRandom(IntPtr Context,Int32 Length,[MarshalAs(UnmanagedType.LPArray)] Byte[] Buffer);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private new static extern Boolean CryptGetKeyParam(IntPtr Key,KEY_PARAM Param,[MarshalAs(UnmanagedType.LPArray)] Byte[] Data,ref Int32 DataLen,Int32 Flags);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptGetUserKey(IntPtr Context,KEY_SPEC_TYPE KeySpec,out IntPtr UserKey);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptImportKey(IntPtr Context,[MarshalAs(UnmanagedType.LPArray)] Byte[] Data,Int32 DataLen,IntPtr PubKey,Int32 Flags,out IntPtr r);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptSetKeyParam(IntPtr Key,KEY_PARAM Param,[MarshalAs(UnmanagedType.LPArray)] Byte[] Data,Int32 Flags);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern void CertAddRefServerOcspResponseContext(IntPtr ServerOcspResponseContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern void CertCloseServerOcspResponse(IntPtr ServerOcspResponse,Int32 Flags);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertAddCertificateContextToStore(IntPtr CertStore,IntPtr CertContext,CERT_STORE_ADD AddDisposition,IntPtr Zero);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertAddCertificateContextToStore(IntPtr CertStore,IntPtr CertContext,CERT_STORE_ADD AddDisposition,out IntPtr StoreContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertAddCertificateLinkToStore(IntPtr CertStore,IntPtr CertContext,Int32 AddDisposition,out IntPtr StoreContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertAddEncodedCertificateToStore(IntPtr CertStore,Int32 CertEncodingType,[MarshalAs(UnmanagedType.LPArray)] Byte[] CertEncodedData,Int32 CertEncodedLength,Int32 AddDisposition,out IntPtr CertContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertDeleteCertificateFromStore(IntPtr CertContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertFreeCertificateContext(IntPtr CertContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertRetrieveLogoOrBiometricInfo(IntPtr CertContext,String LogoOrBiometricType,Int32 RetrievalFlags,Int32 Timeout,Int32 Flags,IntPtr Reserved,out IntPtr ppbData,out Int32 pcbData,out IntPtr ppwszMimeType);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertSerializeCertificateStoreElement(IntPtr CertContext,Int32 Flags,[MarshalAs(UnmanagedType.LPArray)]Byte[] pbElement,ref Int32 pcbElement);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertVerifySubjectCertificateContext(IntPtr Subject,IntPtr Issuer,ref Int32 Flags);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertCreateCertificateContext(Int32 CertEncodingType,[MarshalAs(UnmanagedType.LPArray)]Byte[] CertEncodedBytes,Int32 CertEncodedLength);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertDuplicateCertificateContext(IntPtr CertContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertEnumCertificatesInStore(IntPtr CertStore,IntPtr PrevCertContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertFindCertificateInStore(IntPtr CertStore,Int32 CertEncodingType,Int32 FindFlags,Int32 FindType,IntPtr FindPara,IntPtr PrevCertContext);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertGetIssuerCertificateFromStore(IntPtr CertStore,IntPtr SubjectContext,IntPtr PrevIssuerContext,ref Int32 Flags);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe IntPtr CertAddRefServerOcspResponse(CERT_CHAIN_CONTEXT* ChainContext,Int32 Flags,CERT_SERVER_OCSP_RESPONSE_OPEN_PARA* OpenPara);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe IntPtr CertOpenServerOcspResponse(CERT_CHAIN_CONTEXT* ChainContext,Int32 Flags,CERT_SERVER_OCSP_RESPONSE_OPEN_PARA* OpenPara);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe CERT_SERVER_OCSP_RESPONSE_CONTEXT* CertGetServerOcspResponseContext(IntPtr ServerOcspResponse,Int32 Flags,IntPtr Reserved);
        ...
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe IntPtr CertGetSubjectCertificateFromStore(IntPtr CertStore,Int32 CertEncodingType,CERT_INFO* CertId);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe Boolean CertGetValidUsages(Int32 cCerts,CERT_CONTEXT* rghCerts,Int32* cNumOIDs,IntPtr rghOIDs,Int32* pcbOIDs);
        ...
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern ALG_ID CertOIDToAlgId([MarshalAs(UnmanagedType.LPStr)] String Id);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertAlgIdToOID(ALG_ID Id);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Int32 CertNameToStrA(Int32 CertEncodingType, ref CERT_NAME_BLOB Name, Int32 StrType, IntPtr psz, Int32 csz);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Int32 CertNameToStrW(Int32 CertEncodingType, ref CERT_NAME_BLOB Name, Int32 StrType, IntPtr psz, Int32 csz);
        [DllImport("crypt32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertStrToNameW(Int32 CertEncodingType,[MarshalAs(UnmanagedType.LPWStr)] String Name,Int32 StrType,IntPtr Reserved,[MarshalAs(UnmanagedType.LPArray)] Byte[] EncodedBytes,ref Int32 EncodedLength,IntPtr Error);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptGetHashParam(IntPtr Handle, Int32 Parameter, [MarshalAs(UnmanagedType.LPArray)] Byte[] Block, ref Int32 BlockSize, Int32 Flags);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptGetHashParam(IntPtr Handle, Int32 Parameter, out Int32 Block, ref Int32 BlockSize, Int32 Flags);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptDestroyHash(IntPtr Handle);
        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)] private static extern Boolean CryptVerifySignature(IntPtr Handle, [MarshalAs(UnmanagedType.LPArray)] Byte[] Signature, Int32 SignatureSize, IntPtr Key, IntPtr Description, Int32 Flags);
        [DllImport("advapi32.dll", CharSet = CharSet.Auto, SetLastError = true)] private static extern Boolean CryptSignHash(IntPtr Handle, KEY_SPEC_TYPE KeySpec, IntPtr Sescription, Int32 Flags, [MarshalAs(UnmanagedType.LPArray)] Byte[] Signature, ref Int32 Length);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptCreateHash(IntPtr Provider, ALG_ID Algorithm, IntPtr Key, Int32 Flags, out IntPtr Handle);
        [DllImport("advapi32.dll", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CryptHashData(IntPtr Handle, [MarshalAs(UnmanagedType.LPArray)]Byte[] Data, Int32 DataSize, Int32 Flags);
