...
namespace BinaryStudio.Security.Cryptography
    ...
    internal static class ObjectIdentifiers
        ...
        private const String PKCS1 = "1.2.840.113549.1.1";
        private const String PKCS2 = "1.2.840.113549.1.2";
        private const String PKCS3 = "1.2.840.113549.1.3";
        private const String PKCS4 = "1.2.840.113549.1.4";
        private const String PKCS5 = "1.2.840.113549.1.5";
        private const String PKCS6 = "1.2.840.113549.1.6";
        private const String PKCS7 = "1.2.840.113549.1.7";
        private const String PKCS8 = "1.2.840.113549.1.8";
        private const String PKCS9 = "1.2.840.113549.1.9";
        private const String PKCS10 = "1.2.840.113549.1.10";
        private const String PKCS11 = "1.2.840.113549.1.11";
        private const String PKCS12 = "1.2.840.113549.1.12";
        private const String PKCS13 = "1.2.840.113549.1.13";
        private const String PKCS14 = "1.2.840.113549.1.14";
        private const String PKCS15 = "1.2.840.113549.1.15";
        private const String DODNET = "1.3.6";
        private const String InternetCommunity = "1.3.6.1";
        private const String InternetSecurity = "1.3.6.1.5";
        private const String SecurityMechanism = "1.3.6.1.5.5";
        private const String PKIX = "1.3.6.1.5.5.7";
        public const String PKIXCertificateExtension = "1.3.6.1.5.5.7.1";
        ...
        private const String SMIME = "1.2.840.113549.1.9.16";
        public const String szOID_TIMESTAMP_TOKEN = "1.2.840.113549.1.9.16.1.4";
        public const String szCPOID_RSA_SMIMEaaSigningCertificate = "1.2.840.113549.1.9.16.2.12";
        public const String szCPOID_RSA_SMIMEaaSigningCertificateV2 = "1.2.840.113549.1.9.16.2.47";
        public const String szCPOID_RSA_SMIMEaaETSotherSigCert = "1.2.840.113549.1.9.16.2.19";
        ...
        public const String szOID_ECDSA_SHA224 = "1.2.840.10045.4.3.1";
        ...
        public const String szOID_OIWSECSIG = "1.3.14.3";
        ...
        public const String szOID_RFC3161v21_counterSign = "1.3.6.1.4.1.311.3.3.2";
        public const String szOID_RFC3161v21_thumbprints = "1.3.6.1.4.1.311.3.3.3";
        ...
        public const String szOID_SUR_NAME                      = "2.5.4.4";  // case-ignore string
        public const String szOID_DEVICE_SERIAL_NUMBER          = "2.5.4.5";  // printable string
        ...
        public const String szOID_STATE_OR_PROVINCE_NAME        = "2.5.4.8";  // case-ignore string
        public const String szOID_STREET_ADDRESS                = "2.5.4.9";  // case-ignore string
        public const String szOID_ORGANIZATION_NAME             = "2.5.4.10"; // case-ignore string
        public const String szOID_ORGANIZATIONAL_UNIT_NAME      = "2.5.4.11"; // case-ignore string
        public const String szOID_TITLE                         = "2.5.4.12"; // case-ignore string
        public const String szOID_DESCRIPTION                   = "2.5.4.13"; // case-ignore string
        public const String szOID_SEARCH_GUIDE                  = "2.5.4.14";
        public const String szOID_BUSINESS_CATEGORY             = "2.5.4.15"; // case-ignore string
        public const String szOID_POSTAL_ADDRESS                = "2.5.4.16";
        public const String szOID_POSTAL_CODE                   = "2.5.4.17"; // case-ignore string
        public const String szOID_POST_OFFICE_BOX               = "2.5.4.18"; // case-ignore string
        public const String szOID_PHYSICAL_DELIVERY_OFFICE_NAME = "2.5.4.19"; // case-ignore string
        public const String szOID_TELEPHONE_NUMBER              = "2.5.4.20"; // telephone number
        ...
        public const String szOID_X21_ADDRESS                   = "2.5.4.24"; // numeric string
        public const String szOID_INTERNATIONAL_ISDN_NUMBER     = "2.5.4.25"; // numeric string
        public const String szOID_REGISTERED_ADDRESS            = "2.5.4.26";
        public const String szOID_DESTINATION_INDICATOR         = "2.5.4.27"; // printable string
        ...
        public const String szOID_GIVEN_NAME                    = "2.5.4.42"; // case-ignore string
        public const String szOID_INITIALS                      = "2.5.4.43"; // case-ignore string
        public const String szOID_DN_QUALIFIER                  = "2.5.4.46";
        public const String szOID_DOMAIN_COMPONENT  = "0.9.2342.19200300.100.1.25"; // IA5, UTF8 string
        ...
        public const String CERT_RSA_PUBLIC_KEY_OBJID            = szOID_RSA_RSA;
        public const String CERT_DEFAULT_OID_PUBLIC_KEY_SIGN     = szOID_RSA_RSA;
        public const String CERT_DEFAULT_OID_PUBLIC_KEY_XCHG     = szOID_RSA_RSA;
        ...
        public const String szOID_NTDS_CA_SECURITY_EXT  = "1.3.6.1.4.1.311.25.2";    // OID arc for Microsoft CA custom security extension
        public const String szOID_NTDS_OBJECTSID        = "1.3.6.1.4.1.311.25.2.1";  // OID for objectSid info
        ...
        public const String szOID_CT_CERT_SCTLIST               = "1.3.6.1.4.1.11129.2.4.2"; // OCTET string
        public const String szOID_ENROLL_EK_INFO                = "1.3.6.1.4.1.311.21.23"; // EKInfo
        public const String szOID_ENROLL_AIK_INFO		    = "1.3.6.1.4.1.311.21.39"; // EKInfo
        ...
        public const String szOID_ENROLL_ENCRYPTION_ALGORITHM   = "1.3.6.1.4.1.311.21.29"; // algorithm oid
        ...
        public const String szOID_ENROLL_SCEP_ERROR             = "1.3.6.1.4.1.311.21.33"; // HRESULT
        public const String szOID_ENROLL_SCEP_SERVER_STATE      = "1.3.6.1.4.1.311.21.34"; // blob
        public const String szOID_ENROLL_SCEP_CHALLENGE_ANSWER  = "1.3.6.1.4.1.311.21.35"; // blob
        public const String szOID_ENROLL_SCEP_CLIENT_REQUEST    = "1.3.6.1.4.1.311.21.37"; // Pkcs10
        public const String szOID_ENROLL_SCEP_SERVER_MESSAGE    = "1.3.6.1.4.1.311.21.38"; // String
        public const String szOID_ENROLL_SCEP_SERVER_SECRET     = "1.3.6.1.4.1.311.21.40"; // blob
        public const String szOID_ENROLL_KEY_AFFINITY           = "1.3.6.1.4.1.311.21.41";
        public const String szOID_ENROLL_SCEP_SIGNER_HASH       = "1.3.6.1.4.1.311.21.42"; // blob
        public const String szOID_ENROLL_EK_CA_KEYID            = "1.3.6.1.4.1.311.21.43"; // blob
        ...
        public const String szOID_DISALLOWED_HASH               = szOID_CERT_SIGNATURE_HASH_PROP_ID;
        public const String szOID_CERT_DISALLOWED_FILETIME_PROP_ID = "1.3.6.1.4.1.311.10.11.104";
        public const String szOID_CERT_DISALLOWED_CA_FILETIME_PROP_ID = "1.3.6.1.4.1.311.10.11.128";
