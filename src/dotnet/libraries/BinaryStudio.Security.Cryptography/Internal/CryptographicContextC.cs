...
namespace BinaryStudio.Security.Cryptography.CryptographyServiceProvider
    ...
    internal class CryptographicContextC : CryptographicContext, ICryptoAPI
        ...
        [DllImport("libcapi20", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertEnumCertificatesInStore(HCERTSTORE CertStore,IntPtr PrevCertContext);
        [DllImport("libcapi20", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertFindCertificateInStore(HCERTSTORE CertStore,Int32 CertEncodingType,Int32 FindFlags,Int32 FindType,IntPtr FindPara,IntPtr PrevCertContext);
        [DllImport("libcapi20", CharSet = CharSet.None, SetLastError = true)] private static extern IntPtr CertGetIssuerCertificateFromStore(HCERTSTORE CertStore,IntPtr SubjectContext,IntPtr PrevIssuerContext,ref Int32 Flags);
        [DllImport("libcapi20", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe HCERT_SERVER_OCSP_RESPONSE CertAddRefServerOcspResponse(CERT_CHAIN_CONTEXT* ChainContext,Int32 Flags,CERT_SERVER_OCSP_RESPONSE_OPEN_PARA* OpenPara);
        [DllImport("libcapi20", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe HCERT_SERVER_OCSP_RESPONSE CertOpenServerOcspResponse(CERT_CHAIN_CONTEXT* ChainContext,Int32 Flags,CERT_SERVER_OCSP_RESPONSE_OPEN_PARA* OpenPara);
        [DllImport("libcapi20", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe CERT_SERVER_OCSP_RESPONSE_CONTEXT* CertGetServerOcspResponseContext(HCERT_SERVER_OCSP_RESPONSE ServerOcspResponse,Int32 Flags,IntPtr Reserved);
        ...
        [DllImport("libcapi20", CharSet = CharSet.None, SetLastError = true)] private static extern unsafe IntPtr CertGetSubjectCertificateFromStore(HCERTSTORE CertStore,Int32 CertEncodingType,CERT_INFO* CertId);
