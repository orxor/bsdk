...
namespace BinaryStudio.Security.Cryptography.CryptographyServiceProvider
    ...
    internal class CryptographicContextP : CryptographicContext, ICryptoAPI
        ...
        Boolean ICryptoAPI.CertExportCertStore(IntPtr Store,ref CRYPT_DATA_BLOB PFX,IntPtr Password,IntPtr Para,Int32 Flags){ throw new NotSupportedException(); }
        ...
        [DllImport("libcrypt32", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertAddCertificateContextToStore(HCERTSTORE CertStore,IntPtr CertContext,CERT_STORE_ADD AddDisposition,IntPtr Zero);
        [DllImport("libcrypt32", CharSet = CharSet.None, SetLastError = true)] private static extern Boolean CertAddCertificateContextToStore(HCERTSTORE CertStore,IntPtr CertContext,CERT_STORE_ADD AddDisposition,out IntPtr StoreContext);
