...
internal class HexGroupServiceB : IDirectoryService
    {
    public IFileService Source { get; }
    public HexGroupServiceB(IFileService source)
        {
        Source = source;
        }
        ...
        using (var target = new StreamWriter(stream, Encoding.UTF8)) {
            ...
            using (var reader = new CSVDataReader(
                ...
                while (reader.Read()) {
                    ...
                    var r = new HexFileService(CHIP_1D,
                    ...
                    r = new HexFileService(CHIP_E040,
                        IdentifyDocumentId, fileindex,
                        Source.FileName)
                        {
                        DocumentCategoryName = DocumentCategoryName,
