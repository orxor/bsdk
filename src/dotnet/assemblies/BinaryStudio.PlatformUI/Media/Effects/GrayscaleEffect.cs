...
namespace BinaryStudio.PlatformUI.Media.Effects
    ...
    public sealed class GrayscaleEffect : ShaderEffect
        ...
        public static readonly DependencyProperty DesaturationFactorProperty = DependencyProperty.Register(nameof(DesaturationFactor), typeof(Double), typeof(GrayscaleEffect), new UIPropertyMetadata(0.0, PixelShaderConstantCallback(0), CoerceDesaturationFactor));
