...
namespace BinaryStudio.VSShellServices
    {
    public abstract class ToolWindowCommand<T,F>
        {
        ...
        /// </summary>
        public static ToolWindowCommand<T,F> Instance { get;private set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolWindowCommand&lt;T&gt;"/> class.
        /// </summary>
        /// <param name="package">Owner package, not null.</param>
        /// <param name="commandService">Command service to add command to, not null.</param>
        protected ToolWindowCommand(AsyncPackage package, OleMenuCommandService commandService)
            {
        ...
        public static async Task InitializeAsync(AsyncPackage package)
            {
            // Switch to the main thread, the call to AddCommand in constructor requires
            // the UI thread.
            ...
            Instance = (ToolWindowCommand<T,F>)ctor.Invoke(new Object[]{
                package,
                commandService
                });
            }
